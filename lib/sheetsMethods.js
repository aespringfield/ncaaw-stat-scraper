...
const batchSetPlayerData = (sheets, sheetId, data) => {
  requestWithBackoff(
...
module.exports = { getSheets, getSheetName, listPlayers, listHeadingsAndPlayers, setPlayerData, batchSetPlayerData, authorize };