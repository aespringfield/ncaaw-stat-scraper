...
const CLASS_2024_SHEET_NAME = '2024 draft class';
const CLASS_2023_SHEET_NAME = '2023 draft class';
const CLASS_2022_SHEET_NAME = '2022 draft class';
...
const getSheetName = () => {
  ...
  switch(config.DRAFT_YEAR) {
    ...
    case '2022':
      return CLASS_2022_SHEET_NAME;
    case '2023':
      return CLASS_2023_SHEET_NAME;
    case '2024':
      return CLASS_2024_SHEET_NAME;
    case 'NA':
